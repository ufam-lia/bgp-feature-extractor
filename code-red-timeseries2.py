...
def main():
    ...
    # files = glob.glob("/home/pc/ripe-ris/code-red/updates." + args.start + ".*.gz")
    # files = glob.glob("/home/pc/ripe-ris/code-red/updates.20010710.*.gz")
    # files = files + glob.glob("/home/pc/ripe-ris/code-red/updates.20010711.*.gz")
    # files = files + glob.glob("/home/pc/ripe-ris/code-red/updates.20010712.*.gz")
    files = glob.glob("/home/pc/ripe-ris/code-red/updates.20010713.*.gz")
